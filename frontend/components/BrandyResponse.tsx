...
export default function BrandyResponse({ description, keywords, onClick }: Props) {
  return (
    <div className='container flex flex-col justify-center px-3 sm:pb-3 sm:mx-3 sm:px-10 mt-3'>
        <div className='bg-slate-200 text-black rounded-lg py-3 px-4 drop-shadow-md overflow-y-scroll max-h-60 scroll-m-1'>
          <p  className='text-md font-semibold mb-3'>Your prompt:</p>
          <p className='font-light'>{description}</p>
        </div>
        <div className='bg-slate-200 text-black rounded-lg mt-5 py-3 px-4 drop-shadow-md'>
